import {
  VectorTile_default
} from "./chunk-U2D46LPS.js";
import {
  TileJSON_default
} from "./chunk-QTYX7AXW.js";
import {
  VectorTile_default as VectorTile_default2,
  defaultLoadFunction
} from "./chunk-UGQTKOGW.js";
import {
  Feature_default,
  MVT_default
} from "./chunk-OVXORYP5.js";
import "./chunk-ORCSMIMW.js";
import "./chunk-FJK22R43.js";
import "./chunk-G7JVMNQE.js";
import {
  TileGrid_default
} from "./chunk-FCBCQTOU.js";
import "./chunk-2G6REPGQ.js";
import "./chunk-U6SV4ESY.js";
import "./chunk-MVYANIXF.js";
import "./chunk-Y4DIZSZG.js";
import "./chunk-YRU3NIXS.js";
import "./chunk-OTTU4O27.js";
import "./chunk-KNXVGCHF.js";
import "./chunk-KJO5JNJG.js";
import "./chunk-TWIFIJL2.js";
import "./chunk-M4JRVV4L.js";
import {
  GeoJSON_default
} from "./chunk-O6H2CCPO.js";
import "./chunk-H4XIPWIK.js";
import "./chunk-WKUPAGHI.js";
import "./chunk-VWOTPPNX.js";
import "./chunk-LLEQI66Y.js";
import "./chunk-NGXU6Q42.js";
import "./chunk-IXHUON4T.js";
import "./chunk-Z3MLGJYH.js";
import "./chunk-7RVICDYG.js";
import "./chunk-C4SSGOTW.js";
import "./chunk-47K2DZJG.js";
import "./chunk-UV6JUI6X.js";
import "./chunk-E3JBMD2Z.js";
import "./chunk-FM44FOIC.js";
import "./chunk-F5472VLO.js";
import "./chunk-X5K3DKGA.js";
import "./chunk-IOH77MOB.js";
...
var FormattedSection = function FormattedSection2(text, image, scale, fontStack, textColor) {
...
CompoundExpression.register(expressions, {
  ...
  "get": {
    ...
    overloads: [
      [
        ...
        function(ctx, ref) {
          var key = ref[0];
          return get2(key.evaluate(ctx), ctx.properties());
        }
      ],
      [
        [
        ...
        function(ctx, ref) {
          var key = ref[0];
          var obj = ref[1];
          return get2(key.evaluate(ctx), obj.evaluate(ctx));
        }
      ]
    ]
  },
  "feature-state": [
    ...
    function(ctx, ref) {
      var key = ref[0];
      return get2(key.evaluate(ctx), ctx.featureState || {});
    }
  ],
  "properties": [
    ObjectType,
                ...
                if (geom.getFlatMidpoint || geom.getFlatMidpoints) {
                  ...
                  if (size > 150) {
                    ...
                    if (!renderFeature) {
                      ...
                      renderFeature = new Feature_default("Point", renderFeatureCoordinates, [], {}, null);
                    }
...
function setBackground(mapOrLayer, layer) {
  ...
  function updateStyle(resolution) {
    ...
    var element = typeof mapOrLayer.getTargetElement === "function" ? mapOrLayer.getTargetElement() : void 0;
    var bg, opacity;
...
function applyBackground(mapOrLayer, glStyle, options) {
  ...
  return getGlStyle(glStyle, options).then(function(glStyle2) {
    setFirstBackground(mapOrLayer, glStyle2);
  });
}
...
function setupVectorSource(glSource, styleUrl, options) {
  return new Promise(function(resolve, reject) {
    getTileJson(glSource, styleUrl, options).then(function(tileJSON) {
      ...
      resolve(new VectorTile_default2(sourceOptions));
    }).catch(reject);
  });
}
...
var MapboxVectorLayer = class extends VectorTile_default {
  constructor(options) {
    ...
    const source = new VectorTile_default2({
      state: "loading",
      format: new MVT_default()
    });
    super({
...
// dep:ol_layer_MapboxVector
var ol_layer_MapboxVector_default = MapboxVector_default;
export {
  ol_layer_MapboxVector_default as default
};
//# sourceMappingURL=ol_layer_MapboxVector.js.map
